...
export default function RegisterPage() {
  ...
  return (
    <section className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center bg-muted/30 px-4 py-12">
      {/* Background Pattern */}
      ...
      <div className="relative w-full max-w-md">
        {/* Card */}
        <div className="overflow-hidden rounded-2xl bg-background shadow-xl ring-1 ring-border/50">
          {/* Header */}
          <div className="bg-primary/5 px-6 py-8 text-center">
            <Link href="/" className="inline-flex items-center gap-2">
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-primary">
                <HugeiconsIcon icon={FavouriteIcon} className="h-7 w-7 text-primary-foreground" />
              </div>
            </Link>
            <h1 className="mt-4 text-2xl font-bold text-foreground">Join Our Cause</h1>
